...
export const ScheduleElement = ({id, start_time, end_time, place, eheight}: ScheduleElementTypes) => {
    ...
    return (
      <div onMouseEnter={switchModal} onMouseLeave={closeModal}>     
        <div className={`group shadow-md hover:shadow-xl transition overflow-hidden border rounded-lg pl-3 pr-3 pt-1.5 pb-1.5 h-full border-l-4 ${wallsList[id-1].color}`} style={{ height: `${eheight}px` }}>
